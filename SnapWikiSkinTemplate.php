<?php
/**
 * BaseTemplate class for snapWikiSkin
 *
 * @file
 * @ingroup Skins
 */
...
class SnapWikiSkinTemplate extends BaseTemplate {
	public function execute() {
		...
		?>
<link rel="stylesheet" href="https://snap.berkeley.edu/libs/pure-min.css">
<link rel="stylesheet" href="https://snap.berkeley.edu/style/elements.css">
<link rel="stylesheet" href="https://snap.berkeley.edu/style/classes.css">
<link rel="stylesheet" href="https://snap.berkeley.edu/style/layout.css">
<link rel="stylesheet" href="https://snap.berkeley.edu/libs/reset.css">
<style>
...
<div class="pure-menu-horizontal pure-menu">
        <ul class="pure-g pure-menu-list">
            <a class="pure-u-1-12" href="https://snap.berkeley.edu/" aria-label="Snap! home page">
                <img src="https://snap.berkeley.eduimg/topbar-logo.png" class="logo clickable">
            </a>
...
<?php } ?>
			...
			<li class="link right account-nav">
				<a class="dropdown-toggle">
					<span class="profile-name"><?php if (!$wgUser->isLoggedIn()) { ?><?=wfMessage( 'snapwikiskin-notloggedin' )->inLanguage( $wgLang )->escaped()?><?php } else { ?><?=htmlspecialchars($wgUser->mName)?><?php } ?></span>
				</a>
				<ul class="dropdown">
